...
fun getPart1MD5HashPassword(doorID: String) =
 ...
 * it is ignored, because it specifies an invalid position (8). The second
 * interesting hash is at index 5357525, which produces 000004e...;
...
fun String.replace(position: Int,
                   char: Char): String {
...
//    println(getPart1MD5HashPassword("wtnhxymk"))
    println(getPart2MD5HashPassword("wtnhxymk"))
}