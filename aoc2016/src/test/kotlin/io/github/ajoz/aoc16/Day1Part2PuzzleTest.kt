...
import io.github.ajoz.aoc16.getShortestPathLengthToFirstRepeatedDestination
...
class Day1Part2PuzzleTest : WordSpec() {
    init {
        "The shortest path to first repeated destination (real Bunny HQ)" should {
            ...
            "be 142 for a AOC'16 contest puzzle inputDay3 #1" {
                getShortestPathLengthToFirstRepeatedDestination("""R3, L5, R2, L1, L2, R5, L2, R2, L2, L2, L1, R2, L2, R4, R4, R1,
            ...
            "be 130 for AOC'16 contest puzzle inputDay3 #2" {
                getShortestPathLengthToFirstRepeatedDestination("""L2, L3, L3, L4, R1, R2, L3, R3, R3, L1, L3, R2, R3, L3, R4, R3,
